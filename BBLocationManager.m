...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations
{
    ...
    // self.myLocation = [[CLLocation alloc]initWithLatitude:42.8377151 longitude:-78.7835164];
        ...
        [_locationDelegate didUpdateUserLocation: self.myLocation];
    }
}
...
//{
////    appdelegate.lat_str = [NSString stringWithFormat:@"%f",newLocation.coordinate.latitude];
////    appdelegate.lng_str = [NSString stringWithFormat:@"%f",newLocation.coordinate.longitude];
//    //    self.lat_str=[NSString stringWithFormat:@"%f", newLocation.coordinate.latitude];
//    //    self.lng_str=[NSString stringWithFormat:@"%f", newLocation.coordinate.longitude];
////    self.lat_str = @"40.758899";
////    self.lng_str = @"-73.9873197";
//    //call delegate for
