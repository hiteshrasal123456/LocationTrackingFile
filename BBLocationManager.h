...
@protocol didUpdateLocationDelegate <NSObject>
...
@interface BBLocationManager : NSObject
{
    ...
    __weak id<didUpdateLocationDelegate> _locationDelegate;
}

/**
 *  The delegate, using this the location events are fired.
 */
@property (nonatomic,weak) id <didUpdateLocationDelegate> locationDelegate;
